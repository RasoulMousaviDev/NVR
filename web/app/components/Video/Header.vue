...
<template>
    <div class="flex items-center gap-2">
        ...
        <InputText class="grow ltr" readonly :value="['cameras', ...folders].join('/')" />
        ...
        <Button icon="pi pi-chevron-left" text rounded severity="secondary" :disabled="folders.length == 0 || fetching"
